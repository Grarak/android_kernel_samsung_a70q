...
enum sec_battery_cable {
	...
	SEC_BATTERY_CABLE_PDIC_APDO,		/* 34 */
#endif
...
struct sec_battery_platform_data {
	...
	unsigned int *step_charging_soc_condition;
	unsigned int *step_charging_voltage_condition;
	bool direct_float_voltage_set;
...
#if defined(CONFIG_DIRECT_CHARGING)
	int siop_pd30_input_limit_current;
	int siop_pd30_charging_limit_current;
#endif
